...
3. learning methodology
  ...
  * initialization을 위해 imageNet-Pretrained weights를 사용
  ...
  ![policy 학습 의사코드](https://raw.githubusercontent.com/SUNGBEOMCHOI/SungBeomChoi.github.io/master/assets/img/posts/Learning_to_Fly_by_Clashing/Policy_for_flying_indoor.PNG)
  
  Learning to Fly by Crashing 모델 구조:
  
  ![Learning to Fly by Crashing 모델 구조](https://github.com/SUNGBEOMCHOI/SungBeomChoi.github.io/blob/master/assets/img/posts/Learning_to_Fly_by_Clashing/Learning_to_Fly_by_Crashing_%EB%AA%A8%EB%8D%B8%EA%B5%AC%EC%A1%B0.PNG?raw=true)
...
![연구 결과](https://github.com/SUNGBEOMCHOI/SungBeomChoi.github.io/blob/master/assets/img/posts/Learning_to_Fly_by_Clashing/%EC%8B%A4%ED%97%98%EA%B2%B0%EA%B3%BC.PNG?raw=true)
