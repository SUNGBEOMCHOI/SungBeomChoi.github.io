...
각 GPU의 threads에서 실행된 experience(<img src="https://latex.codecogs.com/gif.latex?\left\{\mathbf{s}_{t}^{j&space;n},&space;\mathbf{u}_{t},&space;r_{t}\right\}" title="\left\{\mathbf{s}_{t}^{j n}, \mathbf{u}_{t}, r_{t}\right\}" />)를 모은다. 
